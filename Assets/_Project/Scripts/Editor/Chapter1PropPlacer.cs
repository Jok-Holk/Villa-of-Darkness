...
public static class Chapter1PropPlacer
{
    ...
    // ─── Model paths ──────────────────────────────────────────────────────────
    const string MODELS = "Assets/_Project/Models/Props/";
    ...
    static void PlaceLivingRoom(GameObject parent)
    {
        ...
        Place(MODELS + "Architecture/Arch_Fireplace_Stone.glb",   "Fireplace",    g, POS_LIVING_ROOM + new Vector3(0, 0, -3f), Quaternion.identity, Vector3.one);
        Place(MODELS + "Prop_Candle_Brass.glb",   "Candle_LR_01",    g, POS_LIVING_ROOM + new Vector3(-1.5f, 0.8f, 1f), Quaternion.identity, Vector3.one);
        Place(MODELS + "Prop_Candle_Brass.glb",   "Candle_LR_02",    g, POS_LIVING_ROOM + new Vector3(1.5f,  0.8f, 1f), Rot(0, 45, 0),        Vector3.one);
        Place(MODELS + "Prop_Lamp_TableOil.glb",  "OilLamp_LR",      g, POS_LIVING_ROOM + new Vector3(2f,    0.7f, -1.5f), Rot(0, 90, 0),    Vector3.one);
        Place(MODELS + "Prop_Portrait_Family.glb","Portrait_Family",  g, POS_LIVING_ROOM + new Vector3(0,     2.5f, -3.5f), Rot(0, 0, 0),     Vector3.one);
        Place(MODELS + "Prop_Vase_Ceramic.glb",   "Vase_LR",         g, POS_LIVING_ROOM + new Vector3(-2f,   0.5f, 0.5f), Rot(0, 135, 0),   Vector3.one);
    ...
    static void PlaceDiningRoom(GameObject parent)
    {
        ...
        Place(MODELS + "Prop_Candle_Brass.glb",   "Candle_DR",       g, POS_DINING_ROOM + new Vector3(0, 0.85f, 0),  Rot(0, 0, 0),   Vector3.one);
        Place(MODELS + "Prop_Vase_Ceramic.glb",   "Vase_DR",         g, POS_DINING_ROOM + new Vector3(3f,  0.9f, 0), Rot(0, 200, 0), Vector3.one);
    }
    ...
    static void PlaceKitchen(GameObject parent)
    {
        ...
        Place(FURN   + "Furn_Table_Kitchen.glb",  "KitchenTable",    g, POS_KITCHEN + new Vector3(0, 0, 0),         Rot(0, 90, 0),   Vector3.one);
        Place(MODELS + "Prop_Shelf_Kitchen.glb",  "KitchenShelf_01", g, POS_KITCHEN + new Vector3(-3f, 1.5f, -1.5f),Rot(0, 90, 0),  Vector3.one);
        Place(MODELS + "Prop_Shelf_Kitchen.glb",  "KitchenShelf_02", g, POS_KITCHEN + new Vector3(-3f, 0.5f, -1.5f),Rot(0, 90, 0),  Vector3.one);
        Place(MODELS + "Prop_Stove_WoodBurning.glb","WoodStove",     g, POS_KITCHEN + new Vector3(2f,  0,    -2f),  Rot(0, 0, 0),    Vector3.one);
        Place(MODELS + "Prop_Jar_Ceramic.glb",    "Jar_01",          g, POS_KITCHEN + new Vector3(-3f, 2.5f,-2.0f), Rot(0, 0, 0),    Vector3.one);
        Place(MODELS + "Prop_Jar_Ceramic.glb",    "Jar_02",          g, POS_KITCHEN + new Vector3(-3f, 2.5f,-1.5f), Rot(0, 60, 0),   Vector3.one);
    }
    ...
    static void PlaceStudyRoom(GameObject parent)
    {
        ...
        Place(MODELS + "Prop_Lamp_TableOil.glb",       "OilLamp_Study",  g, POS_STUDY + new Vector3(0.5f, 0.8f, -0.5f),Rot(0,0,0),  Vector3.one);
        Place(MODELS + "Prop_Frame_Portrait.glb",      "Frame_Study",    g, POS_STUDY + new Vector3(-2.5f, 2.0f, 0), Rot(0, 90, 0),  Vector3.one);
        Place(MODELS + "Prop_Board_Chalk.glb",         "ChalkBoard",     g, POS_STUDY + new Vector3(0, 1.2f, -2.5f), Rot(0, 0, 0),   Vector3.one);
        Place(MODELS + "Prop_SheetMusic.glb",          "SheetMusic_S",   g, POS_STUDY + new Vector3(0.2f, 0.8f,-0.3f),Rot(0,15,0),  Vector3.one);
    }
    ...
    static void PlaceMasterBedroom(GameObject parent)
    {
        ...
        Place(MODELS + "Prop_Lamp_TableOil.glb",       "OilLamp_MB_L",  g, POS_MASTER_BED + new Vector3(-2f, 0.7f,0), Rot(0, 0, 0),   Vector3.one);
        Place(MODELS + "Prop_Lamp_TableOil.glb",       "OilLamp_MB_R",  g, POS_MASTER_BED + new Vector3(2f,  0.7f,0), Rot(0, 180, 0), Vector3.one);
        Place(MODELS + "Prop_Frame_Portrait.glb",      "Frame_MB",      g, POS_MASTER_BED + new Vector3(0, 2.5f,-2.5f),Rot(0,0,0),   Vector3.one);
        Place(MODELS + "Prop_Vase_Ceramic.glb",        "Vase_MB",       g, POS_MASTER_BED + new Vector3(2.5f,0.6f,2f), Rot(0,45,0),  Vector3.one);
    }
    ...
    static void PlaceMrsLanRoom(GameObject parent)
    {
        ...
        Place(MODELS + "Prop_Candle_Brass.glb",        "Candle_ML",    g, POS_MRS_LAN_ROOM + new Vector3(-1.5f,0.7f,0.5f),Rot(0,30,0),Vector3.one);
        Place(FURN   + "Furn_Chair_Armchair.glb",      "Chair_ML",     g, POS_MRS_LAN_ROOM + new Vector3(2f,0,-1f),  Rot(0,-45,0),   Vector3.one);
        Place(MODELS + "Prop_Frame_Portrait.glb",      "Frame_ML",     g, POS_MRS_LAN_ROOM + new Vector3(0,2.2f,-2.5f),Rot(0,0,0),  Vector3.one);
    }
    ...
    static void PlaceGuestRoom(GameObject parent)
    {
        ...
        Place(MODELS + "Prop_Lamp_TableOil.glb",   "OilLamp_GR",      g, POS_GUEST_ROOM + new Vector3(-2f, 0.7f,0),Rot(0,0,0),  Vector3.one);
        Place(MODELS + "Prop_Candle_Brass.glb",    "Candle_GR",       g, POS_GUEST_ROOM + new Vector3(2f, 0.5f, 2f),Rot(0,75,0), Vector3.one);
    }
    ...
    static void PlaceLinhRoom(GameObject parent)
    {
        ...
        Place(MODELS + "Prop_Doll_Porcelain.glb",  "Doll_01",         g, POS_LINHS_ROOM + new Vector3(0, 0.5f,-1f), Rot(0, 180, 0), Vector3.one);
        Place(MODELS + "Prop_Doll_Porcelain.glb",  "Doll_02",         g, POS_LINHS_ROOM + new Vector3(1.5f,0.5f,-1f),Rot(0,-30,0), Vector3.one);
        Place(MODELS + "Prop_Candle_Brass.glb",    "Candle_LR",       g, POS_LINHS_ROOM + new Vector3(-1f, 0.5f,0), Rot(0, 0, 0),  Vector3.one);
    ...
    static void PlacePlayroom(GameObject parent)
    {
        ...
        Place(MODELS + "Prop_Doll_Porcelain.glb",  "Doll_Play_01",    g, POS_PLAYROOM + new Vector3(-1f,  0, -1f),  Rot(0, 45, 0),  Vector3.one);
        Place(MODELS + "Prop_Doll_Porcelain.glb",  "Doll_Play_02",    g, POS_PLAYROOM + new Vector3(1f,   0, -0.5f),Rot(0,-20,0),   Vector3.one);
        Place(MODELS + "Prop_MusicBox_Cylinder.glb","MusicBox_Play",  g, POS_PLAYROOM + new Vector3(0, 0.5f, 1f),   Rot(0, 90, 0),  Vector3.one);
        Place(MODELS + "Prop_Candle_Brass.glb",    "Candle_Play",     g, POS_PLAYROOM + new Vector3(-2f,0.5f, 0),   Rot(0, 0, 0),   Vector3.one);
    }
    ...
    static void PlaceReadingRoom(GameObject parent)
    {
        ...
        Place(MODELS + "Prop_Lamp_TableOil.glb",    "OilLamp_RR",      g, POS_READING_ROOM + new Vector3(-2.5f,2.5f,-1f),Rot(0,0,0),Vector3.one);
    }
    ...
    static void PlaceBasement(GameObject parent)
    {
        ...
        Place(MODELS + "Prop_Candle_Brass.glb",    "Candle_BS_01",    g, POS_BASEMENT + new Vector3(-1f,0.5f, 0),  Rot(0, 0, 0),   Vector3.one);
        Place(MODELS + "Prop_Candle_Brass.glb",    "Candle_BS_02",    g, POS_BASEMENT + new Vector3(2f, 0.5f, 1f), Rot(0, 60, 0),  Vector3.one);
        Place(FURN   + "Furn_Cabinet_Locked.glb",  "Cabinet_BS",      g, POS_BASEMENT + new Vector3(-2f, 0, -2f),  Rot(0, 90, 0),  Vector3.one);
        Place(MODELS + "Prop_Jar_Ceramic.glb",     "Jar_BS",          g, POS_BASEMENT + new Vector3(-2f,0.6f,-1.5f),Rot(0,30,0),  Vector3.one);
    }
    ...
    static void PlaceAtmosphericProps(GameObject parent)
    {
        ...
        Place(MODELS + "Prop_Candle_Brass.glb", "Candle_Hall_01", g, hallCenter + new Vector3(-2f,1f,0), Rot(0,0,0), Vector3.one);
        Place(MODELS + "Prop_Candle_Brass.glb", "Candle_Hall_02", g, hallCenter + new Vector3(2f, 1f,0), Rot(0,45,0),Vector3.one);

        // Portraits in hallway
        Place(MODELS + "Prop_Frame_Portrait.glb",  "Frame_Hall_01", g, hallCenter + new Vector3(-3f,2.5f,0), Rot(0,90,0),Vector3.one);
        Place(MODELS + "Prop_Frame_Portrait.glb",  "Frame_Hall_02", g, hallCenter + new Vector3(3f, 2.5f,0), Rot(0,-90,0),Vector3.one);

        // Vase near entrance
        Place(MODELS + "Prop_Vase_Ceramic.glb",    "Vase_Entrance", g, new Vector3(28.5f,32.5f,25f), Rot(0,0,0), Vector3.one);
    }
