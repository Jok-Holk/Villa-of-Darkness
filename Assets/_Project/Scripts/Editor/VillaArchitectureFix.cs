...
public static class VillaArchitectureFix
{
    ...
    public static void RenameHierarchy()
    {
        ...
        {
            { "ground floor",    "TangTret_GroundFloor"  },
            { "1st floor",       "Tang1_FirstFloor"      },
            { "2nd floor",       "Tang2_SecondFloor"     },
            { "BASEMENT",        "TangHam_Basement"      },
            { "OUTBUILDING",     "NhaPhu_Outbuilding"    },
            { "STAIR (1)",       "CauThang_Main"         },
            { "STAIR (2)",       "CauThang_Secondary"    },
            { "stair fence",     "LanCan_CauThang_A"     },
            { "stair fence (1)", "LanCan_CauThang_B"     },
            { "folding ladder",  "ThangGap"              },
            { "ladder (3)",      "ThangThuong"           },
            { "Watch Tower",     "ThapCanh"              },
            { "well",            "GiengNuoc"             },
            { "Front yard",      "SanTruoc"              },
            { "Stone walkway",   "DuongDa"               },
            { "Wall, column",    "KetCau_Wall_Columns"   },
            { "Floor",           "SanNha_Floors"         },
            { "' house pillar'", "TruNha_Pillars"        },
            { "OUTBUILDING",     "NhaBep_Kitchen_Wing"   },
        };
