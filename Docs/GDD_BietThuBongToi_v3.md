...
Xây dựng năm 1940 bởi Đỗ Văn Minh — địa chủ giàu có người Việt (sửa 2026-07-15: đổi từ 1945 vì đó là năm Nhật đảo chính Pháp rồi Việt Nam giành độc lập, quá loạn lạc cho mốc xây villa). Kiến trúc Đông Dương Late phase (1920–1945), 3 tầng, tháp canh góc đông, vườn cây cổ thụ, giếng đá ở sân sau.
...
| Năm       | Sự kiện                                                                                                                                                                                                                                                 |
| --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1940      | Đỗ Văn Minh hoàn thiện biệt thự. Mang về ba vật phẩm từ một cái giếng ngoài rừng để phong ấn thứ sống trong đó.                                                                                                                                         |
...
>
> Minh Khoa: "Biệt thự Đỗ Gia. Năm 1940, kiến trúc sư Pháp phối hợp ông Đỗ Văn Minh. Đề tài tốt nghiệp của mình không thể thiếu cái này."
>
...
> **Cập nhật 2026-07-27:** Hộp nhạc Ch.1 và log kết thúc Ch.4 KHÔNG nằm trong bảng 8 log dưới đây — 2 log đó **bắt buộc, cài cắm 100% trong gameplay chính** (không phải collectible tuỳ chọn), không tính vào điều kiện "8 Audio Log" của Ending 1. Bảng dưới đây là 8 log TUỲ CHỌN duy nhất quyết định Ending 1, chia đều 2+2 mỗi chapter (thay bảng lệch 3+1 / 1+1+1+1 cũ).

| #   | Nhân vật    | Nội dung ngắn                                  | Vị trí vật phẩm                     | Chapter | Trigger                | Bắt buộc?     |
| --- | ----------- | ----------------------------------------------- | ------------------------------------ | ------- | ---------------------- | ------------- |
| —   | Bà Lan      | Băng ghi âm trong hộp nhạc đồng                 | Thư phòng — nhặt hộp nhạc            | Ch.1    | `[PICKUP]`             | **Bắt buộc** |
| 1   | Bà Lan      | Ngày 3/9/1963 — con Linh thấy mặt trong giếng   | Nhật ký phòng bà Lan I               | Ch.2    | `[EXAMINE]`            | Tuỳ chọn      |
| 2   | Bà Lan      | Ghi bài nhạc lên tường — phấn hết               | Nét phấn tường phòng Linh            | Ch.2    | `[EXAMINE]`            | Tuỳ chọn      |
| 3   | Đỗ Linh     | Tiếng hát khe khẽ — kêu người xuống giếng       | Tranh ảnh hành lang tầng 1           | Ch.2    | `[EXAMINE]`            | Tuỳ chọn      |
| 4   | Đỗ Linh     | _"Nó nói nó đói"_                               | Búp bê / bức vẽ phòng Linh           | Ch.2    | `[EXAMINE]`            | Tuỳ chọn      |
| 5   | Đỗ Văn Minh | Ba vật phong ấn — đừng để chia lìa              | Nhật ký thư phòng tầng trệt          | Ch.3    | `[EXAMINE]`            | Tuỳ chọn      |
| 6   | Đỗ Văn Minh | Mang thứ đó về từ cái giếng ngoài rừng          | Băng ghi âm thư phòng (3 công tắc)   | Ch.3    | Giải câu đố máy ghi âm | Tuỳ chọn      |
| 7   | Đỗ Minh     | _"Ba đừng xuống hầm nữa"_                       | Con tàu gỗ phòng con trai            | Ch.3    | `[EXAMINE]`            | Tuỳ chọn      |
| 8   | Đỗ Minh     | Nghe tiếng ba nói chuyện với ai đó dưới hầm     | Phòng Đỗ Minh — hộp đồ chơi          | Ch.3    | `[EXAMINE]`            | Tuỳ chọn      |
| —   | Bà Lan      | Ký ức cuối — voice khi đặt gương lên bàn thờ    | Tầng hầm — bàn thờ                   | Ch.4    | Đặt vật lên bàn thờ    | **Bắt buộc** |

> **Ending flag:** `GameData.audioLogsHeard >= 8` (đếm 8 log tuỳ chọn #1–#8, KHÔNG tính 2 log bắt buộc Ch.1/Ch.4) → Ending 1 (Giải Thoát). `audioLogsHeard >= 4` → Ending 2 (Thoát Ra). `< 4` → Ending 3 (Thất Bại).
...
9. Text: **NGUYỄN MINH KHOA · 1979 – 2000**
